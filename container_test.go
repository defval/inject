...
func TestContainer_String(t *testing.T) {
	t.Run("container graph", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Equal(t, "digraph  {\n\tsubgraph cluster_s1 {\n\t\tID = \"cluster_s1\";\n\t\tcolor=\"lightgrey\";label=\"\";labelfontname=\"Helvetica\";\n\t\tn4[color=\"#46494C\",fontcolor=\"white\",fontname=\"Helvetica\",label=\"bool\",shape=\"box\",style=\"filled\"];\n\t\t\n\t}subgraph cluster_s0 {\n\t\tID = \"cluster_s0\";\n\t\tcolor=\"lightgrey\";label=\"net/http\";labelfontname=\"Helvetica\";\n\t\tn1[color=\"#46494C\",fontcolor=\"white\",fontname=\"Helvetica\",label=\"*http.ServeMux\",shape=\"box\",style=\"filled\"];\n\t\tn3[color=\"#46494C\",fontcolor=\"white\",fontname=\"Helvetica\",label=\"*http.Server\",shape=\"box\",style=\"filled\"];\n\t\tn2[color=\"#2589BD\",fontcolor=\"white\",fontname=\"Helvetica\",label=\"http.Handler\",style=\"filled\"];\n\t\t\n\t}\n\tn1->n2;\n\tn3->n4;\n\tn2->n3;\n\t\n}", container.String())
	})
}
