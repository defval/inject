...
func TestContainer_Replace(t *testing.T) {
	...
	t.Run("replace not implemented interface", func(t *testing.T) {
		_, err := inject.New(
			inject.Provide(&net.TCPAddr{}, inject.As(new(net.Addr))),
